<div class="container-fluid">
    ...
    <div class="panel-heading">Inventario de Almoxarifado</div>
            ...
            <div class="form-row">
                ...
                <form id="form_cadastro_inventario">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <button type="button" class="btn btn-primary" id="proces_input" onClick="return buscarAlmoxarifadoInventario()" style="margin-top:10px;"> Buscar </button>
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control text-uppercase" name="local" id="local" placeholder="Ex: C0251"  maxlength="5"/>
                    </div>
                    ...
                    <div class="form-row col-md-12">
                        <div class="form-group col-md-4">
                            ...
                            <button type="button" class="btn btn-success" id="proces_input" onClick="return inserirFormInventarioAlmoxarifado()"> Inserir </button>
                            <button type="button" class="btn btn-warning" onClick="limparFormInventarioAlmoxarifado()"> Limpar Tela </button>
                        </div>
                    </div>
