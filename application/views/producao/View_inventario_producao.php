<div class="container-fluid">
    ...
    <div class="panel-heading">Inventario da Produção/Fábrica</div>
        <div class="panel-body">
            ...
            <div class="form-row">
                ...
                <form id="form_cadastro_inventario">
                    ...
                    <div class="form-group col-md-4">
                        <label for="cod_setor">Cod. Setor: </label>
                        <input type="text" class="form-control" name="cod_setor" id="cod_setor" maxlength="6" placeholder="000062" />
                        <button type="button" class="btn btn-primary" id="proces_input" onClick="return buscarSetorInventario()" style="margin-top:10px;"> Buscar </button>
                    </div>
                    
                    <div class="form-group col-md-4">
                        <label for="desc_setor">Desc. Setor </label>
                        <textarea class="form-control" name="desc_setor" id="desc_setor" disabled="disabled" row="10"></textarea>
                    </div>

                    <div class="form-group col-md-4">
                        <label for="cod_prod">Cod. Produto: </label>
                        <input type="text" class="form-control" placeholder="11146" name="cod_prod" id="cod_prod"/>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control text-uppercase" name="os" id="os" placeholder="13658 015" maxlength="9">
                    </div>

                    <div class="form-group col-md-4">
                        <label for="operacao"> Operação: </label>
                        <input type="number" class="form-control" name="operacao" id="operacao" placeholder="05">
                    </div>

                    <div class="form-group col-md-4">
                        <label for="quantidade"> Quantidade: </label>
                        <input type="number" class="form-control" name="quantidade" id="quantidade" placeholder="12 ou 0.20">
                    </div>
                    ...
                    <div class="form-row col-md-12">
                        <div class="form-group col-md-4">
                            ...
                            <button type="button" class="btn btn-success" id="proces_input" onClick="return inserirFormInventarioProducao()"> Inserir </button>
                            <button type="button" class="btn btn-warning" onClick="limparFormInventarioProducao()"> Limpar Tela </button>
                        </div>
                    </div>
